...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2282.07456; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2599.02936; // x position of the perpendicular encoder (in tick units)
    }
